...
from .views import RandomActOfKindnessList, RandomActOfKindnessDetail, RAKClaimList, RAKClaimDetail, ClaimActionList, PayItForwardView, ClaimRAKView, CompleteRAKView, UserProfileView, UserProfileListView
