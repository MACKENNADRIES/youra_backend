...
urlpatterns = [
    ...
    path('rakposts/', RandomActOfKindnessList.as_view(), name='rakpost-list'),  # List and create RAK posts
    path('rakposts/<int:pk>/', RandomActOfKindnessDetail.as_view(), name='rakpost-detail'),  # Retrieve, update, delete RAK posts

    # Claim-related endpoints
    path('claimedraks/', RAKClaimList.as_view(), name='rakclaim-list'),  # List and create RAK claims
    path('rakclaims/<int:pk>/', RAKClaimDetail.as_view(), name='rakclaim-detail'),  # Retrieve, update, delete specific RAK claims
