...
from .views import RandomActOfKindnessList, RandomActOfKindnessDetail, RAKClaimList, RAKClaimDetail, PayItForwardView, UserProfileView, UserProfileListView, LeaderboardView, EnableCollaborationView, JoinRAKView, CustomAuthToken
...
urlpatterns = [
    ...
    path('payitforward/<int:rak_id>/', PayItForwardView.as_view(), name='pay_it_forward'), # Add this line
    ...
    path('api/token/', CustomAuthToken.as_view(), name='custom-token-auth'),
]
