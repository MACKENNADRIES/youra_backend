...
urlpatterns = [
    ...
    path('<int:pk>/', CustomUserDetail.as_view(), name='user-detail'),  # Detail, update, delete specific users
    ...
    path('token/', CustomAuthToken.as_view(), name='custom-token-auth'),  # Custom token authentication without 'api/'
